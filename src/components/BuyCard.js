...
export default function BuyCard(props) {
    ...
    return (
        <div className="w-full lg:w-[600px] flex flex-col items-center justify-center text-center px-2 pb-[100px]">
            <div className="border border-white rounded-md w-full lg:w-11/12 py-2 flex flex-col justify-center text-center px-2 my-3">
                <div className="flex flex-col items-center">
                    <label className="text-3xl sm:text-4xl font-bold block bg-gradient-to-r bg-clip-text text-[#8d5f45]">
                        {`PRESALE - ${icoStatus}`}
                    </label>
